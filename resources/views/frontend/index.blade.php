                ...
                <div class="row align-items-center">
                    <div class="col-11 mx-auto mb-4">
                        <div class="card rounded-0">
                            <div class="card-body">
                                <img class="w-100 shadow" src="{{ asset('/public/') }}/img/coviddir.jpeg" alt="">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row g-0">
                        <div class="col-11 mx-auto my-4 row">
                            <!-- info box start here -->
                    ...
                    <div id="demo" class="col-11 mx-auto mt-4">
                        <h2>Photo Gallery</h2>
